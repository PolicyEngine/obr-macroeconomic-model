...
| **Free-running (add-factors off)** | GDP 4.22%, consumption 7.06%, business investment 11.85%, household income 5.53%, company profits 23.32%, current account 2.74% of GDP. 11 of 21 headline variables are computed at all; the other 10 are held at the OBR's value. See `docs/calibration_scorecard.md`. |
